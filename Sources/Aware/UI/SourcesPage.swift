...
struct SourcesPage: View {
    ...
    private static let legacyCrimeGroup = SourceGroup(
        ...
        sources: [
            ...
            .init(id: "chicago-socrata", name: "City of Chicago",
                  detail: "Chicago open crime data.", url: "https://data.cityofchicago.org",
                  cadence: "when you pan the map", viaAntiLtd: true),
            .init(id: "nyc-socrata", name: "City of New York",
                  detail: "NYC open crime data.", url: "https://data.cityofnewyork.us",
                  cadence: "when you pan the map", viaAntiLtd: true),
            .init(id: "sf-socrata", name: "City of San Francisco",
                  detail: "San Francisco open crime data.", url: "https://data.sfgov.org",
                  cadence: "when you pan the map", viaAntiLtd: true),
            .init(id: "la-socrata", name: "City of Los Angeles",
                  detail: "Los Angeles open crime data.", url: "https://data.lacity.org",
                  cadence: "when you pan the map", viaAntiLtd: true),
            .init(id: "seattle-socrata", name: "City of Seattle",
                  detail: "Seattle SPD crime data.", url: "https://data.seattle.gov",
                  cadence: "when you pan the map", viaAntiLtd: true),
            .init(id: "dc-arcgis", name: "DC Open Data",
                  detail: "Washington DC crime incidents.", url: "https://opendata.dc.gov",
                  cadence: "when you pan the map", viaAntiLtd: true),
            .init(id: "phila-arcgis", name: "City of Philadelphia",
                  detail: "Philadelphia crime incidents.", url: "https://www.opendataphilly.org",
                  cadence: "when you pan the map", viaAntiLtd: true),
            .init(id: "moco-socrata", name: "Montgomery County, MD",
                  detail: "Montgomery County open crime data.", url: "https://data.montgomerycountymd.gov",
                  cadence: "when you pan the map", viaAntiLtd: true),
            .init(id: "pgc-socrata", name: "Prince George's County",
                  detail: "Prince George's County open crime data.", url: "https://data.princegeorgescountymd.gov",
                  cadence: "when you pan the map", viaAntiLtd: true),
            .init(id: "baltimore-arcgis", name: "Open Baltimore",
                  detail: "Baltimore crime via ArcGIS.", url: "https://opendata.baltimorecity.gov",
                  cadence: "when you pan the map", viaAntiLtd: true),
            .init(id: "toronto-arcgis", name: "Toronto Police Service",
                  detail: "Major Crime Indicators open data.", url: "https://data.tps.ca",
                  cadence: "when you pan the map", viaAntiLtd: true),
        ])
